...
const ja: TranslationMap = {
  ...
  'guest.notice.desc': 'ログインしない場合、インタビュー内容は匿名で他のユーザーと共有されます。個人情報や機密情報は含めず、一般的な内容でお試しください。',
  'guest.notice.warn': '※ ログインすると履歴保存・非公開モードが使えます',
  'guest.notice.continue': 'このまま始める',
...
const en: TranslationMap = {
  ...
  'guest.notice.desc': 'Without login, your interview will be shared anonymously with other users. Please keep it general and avoid personal or confidential information.',
  'guest.notice.warn': '※ Log in to save history and keep interviews private',
  'guest.notice.continue': 'Start without login',
...
const es: TranslationMap = {
  ...
  'guest.notice.desc': 'Sin inicio de sesión, tu entrevista se compartirá de forma anónima. Evita incluir información personal o confidencial.',
  'guest.notice.warn': '※ Inicia sesión para guardar historial y mantener la privacidad',
  'guest.notice.continue': 'Continuar sin cuenta',
...
const zh: TranslationMap = {
  ...
  'guest.notice.desc': '未登录时，访谈内容将匿名共享。请避免包含个人或机密信息。',
  'guest.notice.warn': '※ 登录后可保存历史并保持私密',
  'guest.notice.continue': '直接开始',
