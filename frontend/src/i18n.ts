...
const ja: TranslationMap = {
  ...
  'pricing.pro.feat3': 'exe.dev ワンクリックデプロイ (Coming soon)',
...
const en: TranslationMap = {
  ...
  'pricing.trial.feat3': 'Session history saved',
  ...
  'pricing.free.feat2': 'All analysis features available',
  ...
  'pricing.pro.feat3': 'exe.dev one-click deploy (Coming soon)',
