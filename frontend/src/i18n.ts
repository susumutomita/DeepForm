...
const en: TranslationMap = {
  ...
  'pricing.trial.feat3': 'exe.dev one-click deploy (Coming soon)',
  ...
  'pricing.free.feat2': 'exe.dev one-click deploy (Coming soon)',
  'pricing.free.feat3': 'Past sessions always accessible',
  ...
  'pricing.pro.feat2': 'Campaigns (collect feedback from multiple users)',
