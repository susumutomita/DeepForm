...
const ja: TranslationMap = {
  ...
  'step5.title': 'すぐに作り始められる',
  'step5.desc': 'エンジニアやAIエージェントに渡せる形で出力。そのままアプリ開発へ',
  ...
  'feat4.title': 'そのまま開発に渡せる',
  'feat4.desc': '出力をエンジニアやAIエージェントにそのまま渡して、すぐ開発開始。',
...
const en: TranslationMap = {
  ...
  'step5.title': 'Ready to start building',
  'step5.desc': 'Output is ready to hand to engineers or AI agents. Straight to development.',
  ...
  'feat4.title': 'Hands off to development',
  'feat4.desc': 'Output goes straight to engineers or AI coding agents. Start building immediately.',
