...
const ja: TranslationMap = {
  ...
  'step5.desc': '仕様からAIが自動でアプリを生成。コードを書く必要なし (Coming soon)',
  ...
  'feat4.desc': '仕様ができたら、AIが自動でアプリを生成。アイデアから動くものまで一直線 (Coming soon)',
...
const en: TranslationMap = {
  ...
  'step5.desc': 'AI automatically generates a working app from your spec. No coding required (Coming soon)',
  ...
  'feat4.desc': 'Once your spec is ready, AI automatically generates a working app. From idea to live product (Coming soon)',
  ...
  'pricing.trial.feat3': 'AI app generation (Coming soon)',
  ...
  'pricing.free.feat2': 'AI app generation (Coming soon)',
...
const es: TranslationMap = {
  ...
  'step5.desc': 'La IA genera automáticamente una app funcional a partir de tu spec. Sin necesidad de código (Próximamente)',
  ...
  'feat4.desc': 'Cuando tu spec esté lista, la IA genera automáticamente una app funcional. De la idea al producto en vivo (Próximamente)',
  ...
  'pricing.trial.feat3': 'Generación automática de apps con IA (Próximamente)',
  ...
  'pricing.free.feat2': 'Generación automática de apps con IA (Próximamente)',
...
const zh: TranslationMap = {
  ...
  'step5.desc': 'AI 从你的规格书自动生成可运行的应用。无需编程 (即将推出)',
  ...
  'feat4.desc': '规格书就绪后，AI 自动生成可运行的应用。从想法到产品一步到位 (即将推出)',
  'sessions.title': '会话列表',
  'sessions.empty': '暂无会话',
